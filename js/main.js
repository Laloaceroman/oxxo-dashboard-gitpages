...
app.common = {
  init: function() {
    ...
    return $(".dashboard__menuaction").click(function(e) {
      if ($(".dashboard").hasClass("dashboard--navopen")) {
        return $(".dashboard").removeClass("dashboard--navopen");
      } else {
        return $(".dashboard").addClass("dashboard--navopen");
      }
    });
  }
};
...
app.modal = {
  init: function() {
    $("[data-modal-camara]").click(function(e) {
      e.preventDefault();
      return app.modal.open(".dashboard__modal--camara");
    });
    $(".dashboard__modal__close").click(function() {
      return app.modal.close($(this).closest(".dashboard__modal"));
    });
    return $('.dashboard__modal').click(function(e) {
      if ($(e.target).hasClass('dashboard__modal__front')) {
        return app.modal.close($(this).closest(".dashboard__modal"));
      }
    });
  },
  open: function(elementclass) {
    return $(elementclass).addClass("dashboard__modal--in");
  },
  close: function(modal) {
    ...
    if (!modal) {
      modal = $(".dashboard__modal");
    }
    modal.removeClass("dashboard__modal--in").addClass("dashboard__modal--out");
    return setTimeout(function() {
      return modal.removeClass("dashboard__modal--out");
    }, 200);
  }
};
